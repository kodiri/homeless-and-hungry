...
export default class Accommodation extends React.Component {
    render() {
        return (
            <div>
                <img src={AccommodationIcon} className="Icon" alt="Accomodation Icon" />
                <div><h1 className="MainHeading">Accommodation</h1>
                    <div><h1 className="IntroText">Here are your search results for accommodation.</h1>
